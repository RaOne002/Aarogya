...
export const updateAppointment = async ({ userId, appointmentId, appointment, type }: UpdateAppointmentParams) => {
    try {
        ...
        ${type === 'schedule'
            ...
            : `We are sorry to inform you that your appointment with Dr. ${appointment.primaryPhysician} has been cancelled for the following reason: ${appointment.cancellationReason}`
        }
        `
...
function formDateTime(arg0: any) {
